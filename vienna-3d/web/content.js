// Generado por build_content.py a partir del portfolio actual. No editar a mano.
export const CONTENT = {
 ...
 "built": {
  "num": "03",
  "title": "Built on my own.",
  "sub": "Self-taught · shipped · no mockups",
  "intro": "Since 2021 I have been on parental leave, caring for my son. I used the time to stop handing designs over and to build them myself. Kotlin, Jetpack Compose and the modern web stack, all self-taught. One app is live on the Play Store, an AI product went from idea to live in four days. Every one of these is finished and running. Nothing here is a mockup.",
  "items": [
   {
    "n": "01",
    ...
    "title": "SplitEasy",
    "kind": "Android · solo",
    "text": "Bill splitting with on-device receipt scanning: point the camera at a receipt, OCR reads the items, the app splits them. Product, interface, code, store listing, monetisation and consent flow, all of it alone.",
    "stack": [
     "Kotlin",
     "Jetpack Compose",
     "Material 3",
   ...
   },
   {
    ...
    "status": "Live",
    "title": "Module 01",
    "kind": "Interactive learning · ~8 min",
    "text": "A working e-learning module built as a job application, because describing instructional design in a PDF proves nothing. Five chapters, branching scenarios, an xAPI statement fired on every interaction, and a live tracking panel.",
    "stack": [
     "JavaScript",
     "xAPI",
     "WCAG 2.2 AA",
   ...
   },
   {
    ...
    "status": "Live",
    "title": "Mast",
    "kind": "AI product · 4 days",
    "text": "You tie a note to an emotional state instead of a date; months later it recognises you are back in that state and returns your own words. Ships with a forced response schema, a fail-closed parser and a browser-side fallback.",
    "stack": [
     "Vanilla JS",
     "Netlify Functions",
     "Structured output",
   ...
   },
   {
    ...
    "title": "Faro",
    "kind": "Android",
    "text": "Personal finance for people who are not accountants. Privacy is the architecture rather than a policy: no accounts, no sync, no telemetry, encrypted local storage, ads forced to non-personalised with no advertising ID.",
    "stack": [
     "Kotlin",
     "Compose",
     "Room + SQLCipher",
 ...
 "architect": {
  ...
  "sub": "3D · Motion · Brand identity",
  "intro": "Precision-driven design at the intersection of 3D, motion and brand identity. Precision from concept to final render.",
  "facts": [
   {
    "k": "Recognition",
    "v": "SuperRare Open Call Winner. Work exhibited in Times Square, New York and in Rome, Italy."
   },
   {
    "k": "Industry experience",
    "v": "Campaigns for Österreichische Lotterien, Puntigamer, Gösser and OMV through GGK MullenLowe Vienna."
   },
   {
    "k": "Specialisation",
    "v": "3D product visualization · Motion design · Brand identity."
   }
  ]
 },
 "vienna": {
  "num": "04",
  "title": "Vienna, on foot.",
  "sub": "Street photography",
 ...
 "world": {
  "num": "05",
  "title": "World · AI films.",
  "sub": "ComfyUI · MiniMax H3 · independent series",
  "intro": "Short films and key visuals generated locally in ComfyUI with MiniMax H3. Independent creative work exploring World, the on-chain prediction market. The identity, product and positioning are theirs; my work builds on that foundation through key visuals, films and social concepts created for X. Selected work was reposted by @world_xyz.",
  "films": [
   {
  ...
  "visuals": [
   {
    "src": "https://res.cloudinary.com/dsaf6aolb/image/upload/f_auto,q_auto,w_900/v1787575843/1_q2dtzy.jpg",
    "label": "01 · Key visual · Call it and find out"
   },
   {
    "src": "https://res.cloudinary.com/dsaf6aolb/image/upload/f_auto,q_auto,w_900/v1787575843/2_oyijbd.jpg",
    "label": "02 · Key visual · Predict"
   },
   {
    "src": "https://res.cloudinary.com/dsaf6aolb/image/upload/f_auto,q_auto,w_900/v1787575845/3_b5xyvm.jpg",
    "label": "03 · 3D render · What is World"
   },
   {
    "src": "https://res.cloudinary.com/dsaf6aolb/image/upload/f_auto,q_auto,w_900/v1787575845/4_emqrtc.jpg",
    "label": "04 · Key visual · Open to resolve"
   }
  ]
 },
 "about": {
  "num": "06",
  "title": "About me.",
  "sub": "Vienna · from Spain · available for projects",
  "intro": "Graphic designer, 3D artist and motion specialist based in Vienna, originally from Spain. I believe in systems over isolated pieces: visual languages that scale, breathe and last. After building campaigns for major Austrian brands and earning international recognition for my digital art, I bring both strategic thinking and technical precision to every project.",
  "experience": [
   {
    "k": "SuperRare",
    "v": "Open Call Winner. Work exhibited in Rome and Times Square, New York."
   },
   {
    "k": "GGK MullenLowe",
    "v": "Campaigns for Österreichische Lotterien, Puntigamer, Gösser, OMV. Brand consistency across all channels."
   },
   {
    "k": "Securikett",
    "v": "Graphic and label designer in a technically driven environment. Precision workflows, packaging."
   },
   {
    "k": "Bosch",
    "v": "Industrial production in Bavaria. Structured, disciplined, high-precision workflow."
   }
  ],
  "tools": [
   [
